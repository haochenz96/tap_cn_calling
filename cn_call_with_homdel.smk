...
rule gather_NB_EM_results_with_homdel:
    ...
    output:
        result_clone_profiles = 'cn_call_with_homdel/solutions/{cohort_name}-homdel-nclones={nclones}_solution.amp_clone_profiles.csv',
        result_sc_assignments = 'cn_call_with_homdel/solutions/{cohort_name}-homdel-nclones={nclones}_solution.cell_assignments.csv',  
    params:
...
rule plot_cn_clone_profiles_compositions:
    input:
        ...
        result_sc_assignments = 'cn_call_with_homdel/solutions/{cohort_name}-homdel-nclones={nclones}_solution.cell_assignments.csv',     
    output:
        result_clone_profiles_plot = 'cn_call_with_homdel/outputs/{cohort_name}_homdel_nclones={nclones}.cn_clone_profiles.png',
